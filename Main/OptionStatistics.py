...
def optionStatistics(subject):
    ...
    #构造最终DataFrame
    dflist = [df1, df2, df3]
    df = pd.concat(dflist, axis=1, join="inner")[columns]
    print(df)
